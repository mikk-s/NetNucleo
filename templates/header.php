...
<?php if (isset($_SESSION["usuario"])): ?>
 ...
 <a href="<?= $BASE_URL ?>consultar_professores.php">Consultar Professores</a>
 <a href="<?= $BASE_URL ?>consultar_sala.php">Consultar Salas</a>
 <a href="<?= $BASE_URL ?>consultar_aula.php">Consultar Aulas</a>
 </div>
 </li>
 <li class="ExButton">
 <p>Excluir</p>
